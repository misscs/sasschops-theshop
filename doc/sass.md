...
The Shop Filels starting Sass includes:

* [Normalize.css](https://github.com/necolas/normalize.css).
* Useful web best practices defaults.
* Common helper

This starting Sass directory provides small scaffolding. It is designed
for you to expand throughout the workshop.
